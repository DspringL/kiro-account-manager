...
// 当前账号卡片
function CurrentAccountCard({ localToken, refreshing, handleRefresh, isDark, colors, t }) {
  return (
        ...
        {localToken ? (
          <div className="space-y-4">
            <div className="flex items-center gap-4 group relative">
              ...
              {/* Hover 显示 Token 详情 */}
              <TokenDetailPopover localToken={localToken} isDark={isDark} colors={colors} t={t} />
            </div>
          </div>
        ) : (
...
// Token 详情悬浮框
function TokenDetailPopover({ localToken, isDark, colors, t }) {
  return (
