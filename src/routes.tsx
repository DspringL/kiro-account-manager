...
import { Home, Key, Settings2, LogIn, Settings, Info, Network, MessageSquare, UserPlus, LucideIcon } from 'lucide-react'
...
export const routes: RouteConfig[] = [
  ...
  { id: 'autoRegister', icon: UserPlus, nameKey: 'nav.autoRegister', component: lazy(() => import('./components/features/AutoRegister/index')) },
